# Article III: Methodological Constraints

> Annex to [Babylon Constitution](../constitution.md). This file contains the full rationale and details for each methodological constraint.
