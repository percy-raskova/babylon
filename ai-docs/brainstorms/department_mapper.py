    ...
    def __post_init__(self) -> None:
        ...
        if abs(total - 1.0) > 0.001:
            raise ValueError(
                ...
                f"I={self.dept_I}, IIa={self.dept_IIa}, IIb={self.dept_IIb}, III={self.dept_III}"
            )
...
class DepartmentMapper:
    ...
    def from_yaml(cls, path: str | Path) -> DepartmentMapper:
        ...
        return cls(defaults=defaults, overrides=overrides, excluded=excluded)
    ...
    if _default_mapper is None:
        if config_path is None:
            ...
            candidates = [
                ...
                Path(__file__).parent / "naics_to_dept.yaml",
            ...
            for candidate in candidates:
                ...
                raise FileNotFoundError(f"Could not find naics_to_dept.yaml in: {candidates}")
