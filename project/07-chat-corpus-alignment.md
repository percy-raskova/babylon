...
| M10 | **Scale-out/federation**: CONUS ≈ 2M hexes/50M edges; the cliff is Pydantic-per-hex (fix: columnar substrate) + Ollivier-Ricci LP (fix: cache/Forman); `FederatedBoundaryNode` for interoperating national instances (2026-05-12, 2026-01-29).                                                                                                                                                                                                                                                                    | [V]                  | Wave 7                                        |
...
## 4. Dialectics-engine findings (written into `06` §9 — summary)
