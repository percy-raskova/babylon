...
- Live project state: `ai-docs/state.yaml` (v2.15.0+), `ai-docs/decisions/`
  (ADR index — ADR051 dialectics + ADR052 graph substrate are the two newest
  load-bearing records), `ai-docs/tuning-standard.yaml` (20-Year Entropy
  Standard).
