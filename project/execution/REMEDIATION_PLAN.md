...
| 2.R `proof/baseline-regen-2026-07` | M | ONE regen covering 2.2+2.3+the already-merged gamma wiring (closes the cc4a5303 R-PROOF violation): fresh 520-tick canonical, diff vs old, commit baseline + proof.md. C.8 wiring audit lands here so the manifest proves what was wired |
