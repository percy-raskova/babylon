...
| 11 | TransportSystem | HYBRID | 185 | none named in spec §6.4 inventory | none found | none found | GAPPED — Task 11 (P26 U5e default-OFF, `TransportDefines.enabled=False`; no canonical scenario enables the corridor mesh — byte-identical by design) | BSL guards/thresholds + named intrinsic core (`domain.geography.corridor_mesh`) | |
