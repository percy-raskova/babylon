...
fn declared_int_field_seeds_as_county_map_rows_with_zero_padded_geoids() {
    let rows = extract_declared_territory_county_map_v1(DECLARED_SCENARIO)
...
"
        ...
        let error = extract_declared_territory_county_map_v1(&source)
...
",
    ...
    assert_eq!(error, TerritoryCountyMapErrorV1::FieldNotInt);
}
