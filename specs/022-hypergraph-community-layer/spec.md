...
- **FR-003**: System MUST support three categories of community types per Constitution II.7. Category 1 (Contradiction Pairs, both sides): SETTLER, PATRIARCHAL, NEW_AFRIKAN, FIRST_NATIONS, CHICANO, WOMEN, TRANS. Category 2 (Institutional Exclusion, marginalized only): DISABLED, QUEER, UNDOCUMENTED, INCARCERATED. Category 3 (Lifecycle Phases): YOUTH, ADULT, ELDER. No ABLED, HETEROSEXUAL, or CISGENDER — these are institutional defaults, not communities (VIII.10).
