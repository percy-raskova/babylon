...
- [ ] T006 [P] Extend src/babylon/data/defines.yaml with `organization:` section containing all 14 OrganizationDefines parameters with their default values, following the existing YAML structure pattern.
