...
| AC10 (SC-004) | National-total `phi_hour` (sum across counties × employment-hours) within order-of-magnitude of Hickel et al. 2022 ($2.8T, 2015) | `test_national_total_within_oom_of_hickel_2015` — assert `1e11 < total_drain_2015 < 1e13` (i.e., $100B–$10T) |
