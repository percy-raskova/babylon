...
- [ ] T017 [US1] Create `src/babylon/persistence/postgres_runtime/_pool.py` containing the `AsyncConnectionPool` ownership and retry logic extracted from `_legacy.py`; facade `__init__.py` instantiates the pool wrapper; tests must pass (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
- [ ] T018 [US1] Create `src/babylon/persistence/postgres_runtime/tick_io.py` containing `PostgresTickIO` (per-tick state read/write methods); facade `__init__.py` adds `self._tick = PostgresTickIO(pool)` and pass-through methods; commit `refactor(persistence): extract PostgresTickIO` (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
- [ ] T019 [US1] Create `src/babylon/persistence/postgres_runtime/archival_io.py` containing `PostgresArchivalIO` (Phase 8 stub preserved verbatim per spec.md Edge Case bullet); facade adds `self._archival`; commit `refactor(persistence): extract PostgresArchivalIO` (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
- [ ] T020 [US1] Create `src/babylon/persistence/postgres_runtime/spatial_io.py` containing `PostgresSpatialIO` (PostGIS hex queries); facade adds `self._spatial`; commit `refactor(persistence): extract PostgresSpatialIO` (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
- [ ] T021 [US1] Create `src/babylon/persistence/postgres_runtime/community_io.py` containing `PostgresCommunityIO` (XGI hyperedge state); facade adds `self._community`; commit `refactor(persistence): extract PostgresCommunityIO` (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
- [ ] T022 [US1] Create `src/babylon/persistence/postgres_runtime/trace_io.py` containing `PostgresTraceIO` (TraceCollector impl); facade adds `self._trace`; commit `refactor(persistence): extract PostgresTraceIO` (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
- [ ] T023 [US1] Delete `src/babylon/persistence/postgres_runtime/_legacy.py` once all methods have been extracted and the facade is the sole public entry point; verify facade `__init__.py` is ≤200 LOC and every sub-module is ≤400 LOC (`find src/babylon/persistence/postgres_runtime -name "*.py" -exec wc -l {} +`); commit `refactor(persistence): delete postgres_runtime legacy monolith` (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
...
- [ ] T026 [US1] Create `src/babylon/engine/simulation/orchestrator.py` containing `SimulationOrchestrator` (tick pipeline); facade composes `self._orchestrator`; commit `refactor(engine): extract SimulationOrchestrator` (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
- [ ] T027 [US1] Create `src/babylon/engine/simulation/observer_dispatch.py` containing `ObserverDispatcher` (fanout to `SimulationObserver` impls); facade composes `self._observers`; commit `refactor(engine): extract ObserverDispatcher` (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
...
- [ ] T029 [US1] Create `src/babylon/engine/simulation/error_recovery.py` containing `SimulationRecovery` (invariant rollback); facade composes `self._recovery`; commit `refactor(engine): extract SimulationRecovery` (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
- [ ] T030 [US1] Delete `src/babylon/engine/simulation/_legacy.py`; verify facade ≤200 LOC and every sub-module ≤400 LOC; commit `refactor(engine): delete simulation legacy monolith` (unchecked 2026-07-08: split not present — see project/HOLISTIC_REVIEW-2026-07-07.md; scheduled Phase 4 of project/REMEDIATION_PLAN.md)
