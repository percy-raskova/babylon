...
:class:`~babylon.dialectics.core.opposition.BoundOpposition` components and
...
:class:`~babylon.dialectics.core.opposition.OppositionState` rows), makes
...
See Also:
    :class:`babylon.dialectics.core.opposition.OppositionRegistry`: steps
...
from babylon.dialectics.core.opposition import BoundOpposition, GapReading

if TYPE_CHECKING:
    from babylon.dialectics.core.opposition import OppositionSpec
