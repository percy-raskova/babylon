...
See Also:
    :mod:`babylon.domain.bifurcation.axis`: Per-axis computation.
    :mod:`babylon.domain.bifurcation.bridges`: Bridge detection.
    :mod:`babylon.domain.bifurcation.consciousness`: Consciousness weighting.
    :mod:`babylon.domain.bifurcation.legitimation`: Legitimation amplifier.
    :mod:`babylon.domain.bifurcation.resilience`: Topological resilience.
"""
...
from babylon.domain.bifurcation.axis import compute_axis_tendency, crosses_contradiction_axis
...
from babylon.domain.bifurcation.types import BifurcationResult
...
def bifurcation_tendency(
    ...
    See Also:
        :class:`babylon.domain.bifurcation.types.BifurcationResult`: Result type.
        :func:`babylon.domain.bifurcation.axis.compute_axis_tendency`: Per-axis analysis.
    """
