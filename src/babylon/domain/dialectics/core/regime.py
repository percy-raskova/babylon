...
See Also:
    :class:`babylon.domain.dialectics.core.level.LevelLattice`: supplies ``aufhebung_of``.
    :class:`babylon.domain.dialectics.core.opposition.OppositionState`: the trajectory.
"""
...
if TYPE_CHECKING:
    from babylon.domain.dialectics.core.level import LevelLattice
