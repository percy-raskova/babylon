...
Grounds :class:`babylon.domain.dialectics.core.cylinder.AdjointCylinder` in the
...
- :math:`\\Pi_0` (:func:`pieces`) — connected components. This is a
  ...
  :class:`~babylon.domain.dialectics.core.cylinder.AdjointCylinder` (which only
...
<babylon.domain.dialectics.core.cylinder.AdjointCylinder.balance>` measures,
...
.. warning::
    ...
    instead (see :mod:`babylon.domain.dialectics.core.cylinder`).
