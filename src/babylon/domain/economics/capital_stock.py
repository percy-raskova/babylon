...
See Also:
    :class:`babylon.domain.economics.depreciation.DepreciationConfig`: Depreciation configuration.
    :class:`babylon.domain.economics.derived_metrics.DerivedTensorMetrics`: Metrics container.
    :class:`babylon.domain.economics.tensor_registry.TensorRegistry`: Tensor data source.
