...
See Also:
    :class:`babylon.domain.economics.circulation.types.PureCirculationCosts`: Cost model
    :class:`babylon.domain.economics.circulation.types.TransportationValue`: Transport model
"""
