...
See Also:
    :class:`babylon.domain.economics.capital_stock.CapitalStockCalculator`: Uses config for K computation.
    :mod:`babylon.domain.economics.tensor`: ValueTensor4x3 provides total_c (investment).
