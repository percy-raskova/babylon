...
See Also:
    :mod:`babylon.domain.economics.dynamics.data_sources`: CrisisAmplifier protocol
    :mod:`babylon.domain.economics.tick.types`: CrisisPhase, PhasedAmplificationProfile
"""

from __future__ import annotations

from babylon.domain.economics.dynamics.types import TransitionRates
from babylon.domain.economics.tick.types import CrisisPhase, PhasedAmplificationProfile
