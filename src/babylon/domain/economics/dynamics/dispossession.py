...
See Also:
    :mod:`babylon.domain.economics.dynamics.data_sources`: DispossessionCalculator protocol
    :mod:`babylon.domain.economics.dynamics.hardcoded_data`: MVP data source
"""
