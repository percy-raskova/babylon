...
Note: a separate process-wide :class:`~babylon.domain.economics.protocol_kit.SourceRegistry`
...
from babylon.domain.economics.dynamics.hardcoded_data import HardcodedNationalDispossessionSource
...
from babylon.domain.economics.melt.basket_visibility import DefaultBasketVisibilityCalculator
from babylon.domain.economics.melt.gamma_hydration import SQLiteGammaHydrationSource
from babylon.domain.economics.protocol_kit import SourceRegistry
...
def create_financial_services(
    ...
    *,
    ...
    from babylon.domain.economics.data_adapters import CensusHousingLoader, Z1Loader
...
def create_vol1_services(
    ...
    # ADR108's "wire dispossession into class transitions" charter.
