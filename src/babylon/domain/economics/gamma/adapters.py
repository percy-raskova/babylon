...
See Also:
    :mod:`babylon.domain.economics.melt.data_sources`: QCEW protocol definitions
    :mod:`babylon.domain.economics.gamma.data_sources`: PaidCareHoursSource protocol
"""
...
class MVPUnpaidCareHoursSource:
    ...
    See Also:
        :mod:`babylon.domain.economics.gamma.data_sources`: UnpaidCareHoursSource protocol
        :class:`babylon.domain.economics.dynamics.hardcoded_data.HardcodedNationalDispossessionSource`:
