...
See Also:
    :mod:`babylon.domain.economics.gamma.types`: ERDIData and MVP_ERDI_VALUES
    :mod:`babylon.domain.economics.gamma.data_sources`: ERDISource protocol
"""
...
from babylon.domain.economics.gamma.validation import validate_gamma_import
