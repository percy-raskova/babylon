...
optional :class:`~babylon.domain.economics.melt.gamma_hydration.GammaHydrationSource`
...
class DefaultBasketVisibilityCalculator(CachedSource[float]):
    ...
    :class:`~babylon.domain.economics.melt.gamma_hydration.GammaHydrationSource`
    ...
    See Also:
        :mod:`babylon.domain.economics.melt.gamma_hydration`: Optional hydration source.
    """
