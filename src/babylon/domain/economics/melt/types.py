...
class ClassPosition(Enum):
    ...
    Example:
        >>> from babylon.domain.economics.melt import ClassPosition
...
class PrecarityStatus(Enum):
    ...
    Example:
        >>> from babylon.domain.economics.melt import PrecarityStatus, ClassPosition
        >>> from babylon.domain.economics.melt import DefaultClassPositionClassifier
