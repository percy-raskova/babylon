...
class DefaultWealthProxyCalculator(CachedSource[float]):
    ...
    def estimate_la_share(self, fips: str, year: int) -> float:
        ...
        .. deprecated::
            ...
            :func:`babylon.domain.economics.substrate.transitions.check_equity_threshold`
            and :func:`babylon.domain.economics.substrate.transitions.evaluate_class_shares`
        ...
        warnings.warn(
            ...
            "See babylon.domain.economics.substrate.transitions.",
            DeprecationWarning,
            stacklevel=2,
        )
