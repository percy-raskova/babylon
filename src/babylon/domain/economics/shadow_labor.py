...
See Also:
    ...
    :mod:`babylon.domain.economics.reproduction`: Imperial rent calculation.
    :mod:`babylon.domain.economics.tensor`: ValueTensor4x3 (economic primitive).
"""
...
class ReproductionLoaderProtocol(ABC):
    ...
    See Also:
        ...
        :mod:`babylon.domain.economics.adapters`: Similar adapter patterns.
    """
