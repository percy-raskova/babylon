...
See Also:
    :mod:`babylon.domain.economics.substrate.types`: HexGrid resolution hierarchy.
    :mod:`babylon.domain.economics.substrate.conservation`: Hierarchical conservation.
"""
