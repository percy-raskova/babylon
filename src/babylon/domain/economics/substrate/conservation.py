...
See Also:
    :mod:`babylon.domain.economics.substrate.types`: HexGrid and HexEconomicState.
    :mod:`babylon.domain.economics.substrate.validation`: Three-tier value validation.
"""
