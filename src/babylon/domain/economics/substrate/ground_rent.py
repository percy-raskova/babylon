...
See Also:
    :mod:`babylon.domain.economics.substrate.equalization`: Capital migration logic.
    :mod:`babylon.domain.economics.substrate.transitions`: Discrete tenure mutations.
