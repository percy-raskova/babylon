...
from :mod:`babylon.domain.economics.tick.graph_bridge`.

See Also:
    :mod:`babylon.domain.economics.substrate.aggregation`: Aggregator methods.
    :mod:`babylon.domain.economics.tick.graph_bridge`: County-level bridge.
