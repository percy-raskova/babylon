...
See Also:
    :mod:`babylon.domain.economics.temporal.protocols`: AnomalyDetector protocol
    :mod:`babylon.domain.economics.temporal.models`: AnomalyFlag, AnomalyThresholdConfig
"""
