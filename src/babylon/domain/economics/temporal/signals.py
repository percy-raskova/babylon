...
See Also:
    :mod:`babylon.domain.economics.temporal.protocols`: DeindustrializationDetector protocol
    :mod:`babylon.domain.economics.temporal.models`: DeindustrializationSignal model
"""
