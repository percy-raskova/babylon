...
See Also:
    :mod:`babylon.domain.economics.temporal.protocols`: CoefficientSmoother protocol
    :mod:`babylon.domain.economics.temporal.models`: SmoothedCoefficientSeries model
"""
