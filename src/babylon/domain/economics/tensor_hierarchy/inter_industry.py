...
See Also:
    :mod:`babylon.domain.economics.tensor_hierarchy.types`: InterIndustryFlow, LeontiefInverse.
...
class DefaultDepartmentAggregator:
    ...
    def get_default_mapping(self) -> dict[str, str]:
        ...
        :data:`babylon.domain.economics.tensor_hierarchy.mappings.BEA_TO_DEPARTMENT`
        ...
        Returns:
            ...
            (e.g. "111CA" -> "I", "621" -> "III").
        """
        from babylon.domain.economics.tensor_hierarchy.mappings import BEA_TO_DEPARTMENT
