...
class BEAMappings(BaseModel):
    ...
    :class:`babylon.domain.economics.tensor_hierarchy.inter_industry.DefaultDepartmentAggregator`.
    ...
    def as_flat_dict(self) -> dict[str, str]:
        ...
        Matches the legacy
        :meth:`babylon.domain.economics.tensor_hierarchy.inter_industry.DefaultDepartmentAggregator.get_default_mapping`
