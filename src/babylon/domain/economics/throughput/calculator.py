...
from babylon.domain.economics.throughput.types import CommuterAdjustedMetrics, ThroughputMetrics
from babylon.formulas.constants import HOURS_PER_YEAR

if TYPE_CHECKING:
    from babylon.domain.economics.melt import MELTCalculator
    from babylon.domain.economics.throughput.data_sources import (
        BEACountyGDPSource,
        LODESCommuterFlowSource,
        QCEWCountyNAICSSource,
    )
    from babylon.domain.economics.throughput.supply_chain import SupplyChainAnalyzer
