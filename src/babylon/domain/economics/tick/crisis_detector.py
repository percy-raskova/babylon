...
See Also:
    ...
    :mod:`babylon.domain.economics.tick.types`: CrisisState, CrisisPhase
"""
...
class MultiPeriodCrisisDetector:
    ...
    See Also:
        :class:`babylon.domain.economics.tick.types.CrisisState`: State tracked by this detector.
        :class:`babylon.domain.economics.tick.types.CrisisPhase`: Phase enumeration.
    """
