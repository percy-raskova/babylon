...
See Also:
    :mod:`babylon.domain.economics.tick.types`: DerivedRates, TickSummary
    :mod:`babylon.domain.economics.tick.system`: Pipeline integration (Step 8)
"""
...
from babylon.domain.economics.tick.types import DerivedRates
