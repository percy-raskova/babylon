...
See Also:
    ...
    :mod:`babylon.domain.economics.tick.graph_bridge`: Graph serialization
"""
...
class TickDynamicsSystem(SystemBase):
    ...
    def _compute_imperial_rent(
        ...
        :func:`babylon.domain.economics.tick.system.imperial_rent.compute` orchestration
    ...
    def _compute_accumulation_loop(
        ...
        scenario-seeded value would be a fabricated input, ADR108 ruling (a)).
