...
See Also:
    ...
    :mod:`babylon.domain.geography.r8_mesh`: generate_r8_mesh, classify_r8_terrain.
    :mod:`babylon.domain.geography.r8_aggregation`: R8 → R7 aggregation.
    :mod:`babylon.domain.geography.natural_earth_reader`: NE data reader.
"""
...
from babylon.domain.geography.r8_aggregation import (
    aggregate_infrastructure_routing,
    aggregate_terrain,
    aggregate_utility_coverage,
)
from babylon.domain.geography.r8_mesh import classify_r8_terrain, generate_r8_mesh
from babylon.domain.geography.r8_types import R8FeatureType, R8LinearFeature
...
def build_r8_substrate(
    ...
    if ne_reader is None:
        from babylon.domain.geography.natural_earth_reader import NaturalEarthReader
