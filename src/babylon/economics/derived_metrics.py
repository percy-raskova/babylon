...
See Also:
    :class:`babylon.economics.capital_stock.CapitalStockCalculator`: Computes K and metrics.
    :class:`babylon.economics.tensor.ValueTensor4x3`: Source tensor with flow-based rate.
