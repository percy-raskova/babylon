...
See Also:
    :mod:`babylon.economics.dynamics.savings_schedule`: Default savings rates
    :mod:`babylon.economics.dynamics.data_sources`: AccumulationCalculator protocol
"""
...
from babylon.economics.dynamics.types import AccumulationResult
