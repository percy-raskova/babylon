...
Kills the hardcoded seam in :mod:`babylon.economics.melt.basket_visibility`
...
SQLAlchemy adapter pattern as :mod:`babylon.economics.melt.adapters`.
...
Formulas:
    ...
    - ``gamma_import`` (basket visibility of imported goods):
      ...
      sibling module :mod:`babylon.economics.gamma.gamma_import`'s formula
...
See Also:
    :mod:`babylon.economics.melt.basket_visibility`: Consumer of this adapter.
    :mod:`babylon.economics.melt.adapters`: Sibling national-level adapters
