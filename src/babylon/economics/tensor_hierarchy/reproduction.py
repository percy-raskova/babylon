...
See Also:
    :mod:`babylon.economics.tensor_hierarchy.types`: ReproductionRequirements type.
    :mod:`babylon.economics.tensor_hierarchy.protocols`: ReproductionSource protocol.
"""
