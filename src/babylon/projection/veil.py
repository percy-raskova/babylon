...
Relocated from ``web/game/veil.py`` by Program 24 P2 WO-41 (the web module
is now a re-export shim, same Hoist pattern as fog/verb copy) — the doctrine
veil gates TUI projections and legacy serializers through ONE module.
