...
class InvalidObjectError(LifecycleError):
    ...
    """
    def __init__(self, message: str, error_code: str = "RAG_101", field_name: str | None = None, current_value: any = None) -> None:
...
class StateTransitionError(LifecycleError):
    ...
    """
    def __init__(self, message: str, error_code: str = "RAG_121", current_state: str | None = None, target_state: str | None = None) -> None:
...
class CorruptStateError(LifecycleError):
    ...
    """
    def __init__(self, message: str, error_code: str = "RAG_161", affected_objects: list[str] | None = None) -> None:
