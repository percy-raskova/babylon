...
Vol I's U2 (ADR109, ``feat(dialectics): the Fundamental Theorem, computed``)
...
unwired (ADR109's own recorded scope boundary: it is a rate/drift formula,
...
#: caller (``value_form.py::compute_fundamental_theorem``, U2/ADR109); the
...
#: literals, never real tick data). ADR109 (Vol I U2) recorded the same
...
FORMULA_EXEMPTIONS: Final[tuple[SentinelExemption, ...]] = (
    SentinelExemption(
        ...
        reason=(
            ...
            "'the formula cannot be honestly invoked without them'). ADR109 (Vol I U2) "
        ...
        date="2026-07-21",
        tracking_task="N/A (ADR109 scope boundary; no committed remediation unit exists)",
    ),
)
