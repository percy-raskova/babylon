...
_TERRITORY_TICK_METRICS: tuple[SeamEntry, ...] = (
    ...
    # were the textbook gated-dormancy case (program prompt §2b, ADR108):
    ...
    SeamEntry(
        ...
        read_paths=_TERRITORY_EMITTERS,
        spec_ref="Feature 021 · Vol I U3 · ADR108 · ADR110",
        notes=(
            ...
            "_territory_graph_attr. Previously the textbook gated-dormancy case (ADR108): "
    ...
    SeamEntry(
        ...
        notes=(
            ...
            "(ADR108), now sourced from the FRED-backed _FredDispossessionAdapter (hardcoded "
