...
# The client-contract seam moved to babylon.tui.contract at the M7 cutover
# decoupling (textual-free, so the Rust host survives this module's
# deletion); imported back for this module's own annotations until the
# ceremony deletes ArchiveApp outright.
