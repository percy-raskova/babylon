 ...
 * extended by Track 2 T2-0: /login, /lobby, /game/:id/briefing, and the
 * `/game/:id` LAYOUT (GameRoute) with its screen children — the map
 * (index, MapRoute) and the Circuit (circuit, CircuitRoute). Unauthenticated
