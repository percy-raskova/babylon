...
/** `BottomDrawer`'s five states (architecture §1.4): closed, or one of its four contents. */
export type BottomDrawerState = "none" | "trends" | "events" | "economy" | "state-apparatus";
