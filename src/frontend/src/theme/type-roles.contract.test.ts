/**
 * Type-role token contract (spec-090 residual d), re-guarded for the cockpit
 * at spec-112 (Phase D cutover) — ported from
 * web/frontend/src/theme/type-roles.contract.test.ts before that app's
 * deletion.
 *
