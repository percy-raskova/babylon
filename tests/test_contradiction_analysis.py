...
class TestContradictionAnalysis(unittest.TestCase):
    ...
    def _create_sample_contradiction(self) -> Contradiction:
        ...
        return Contradiction(
            ...
            attributes={},
            update_intensity=lambda self, game_state: Contradiction.update_intensity_from_economy(self, game_state)
        )
    ...
    def test_detect_new_contradictions(self) -> None:
        ...
        new_contradictions: List[Contradiction] = self.contradiction_analysis.detect_new_contradictions(self.game_state)
    ...
    def test_generate_events(self) -> None:
        ...
        events: List[Event] = self.contradiction_analysis.generate_events(self.game_state)
