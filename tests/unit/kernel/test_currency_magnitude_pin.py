...
# Pinned from the 2026-08-23 census (reports/currency-magnitude-census-2026-08-23.md),
# rounded UP to 2 sig figs: observed max was 5.78329e13
# (michigan-e2e.json.external_node_flows[2].total_phi_inflow, the 83-county
...
def test_i64_microunits_already_overflow_at_current_scale() -> None:
    ...
    See reports/currency-magnitude-census-2026-08-23.md for the finding."""
