...
# test_design_bible_truecolor_row_matches_theme retired with
# babylon.tui.theme (Amendment AF / ADR186 deletion ceremony): that module
# was the Ratatui client's own independently-hardcoded truecolor copy,
# checked against the doc directly as insurance against theme.py drifting
# from tiers.TRUECOLOR_PALETTE without either import catching it. No client
# module carries that kind of copy today; the AF (v) carried theme-parity
# guard is tests/unit/render/test_rust_theme_parity.py (deleted here,
# re-created in Phase C re-pointed at babylon-client's own palette.rs). The
# degraded-row test above still guards babylon.render.tiers directly.
