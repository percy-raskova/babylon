...
EXPECTED_DEFINES_PUBLIC: frozenset[str] = frozenset(
    {
        ...
        "TimescaleDefines",
        "TopologyDefines",
        "TradePolicyDefines",  # P26 U5f / tariff levers (ADR168, deliberate surface addition)
        "TransportDefines",  # P26 U5e / transport slice 1 (ADR166, deliberate surface addition)
