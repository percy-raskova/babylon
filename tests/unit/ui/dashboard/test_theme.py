...
class TestProfitRateToRgb:
    """Tests for profit_rate_to_rgb() color mapping function."""

    def test_rate_zero_returns_red(self) -> None:
        """profit_rate=0.0 should return phosphor_burn_red."""
        result = profit_rate_to_rgb(0.0)
    ...
    def test_rate_quarter_returns_interpolated(self) -> None:
        ...
        result = profit_rate_to_rgb(0.25)
    ...
    def test_rate_three_quarters_returns_interpolated(self) -> None:
        ...
        result = profit_rate_to_rgb(0.75)
...
class TestProfitRateToHex:
    ...
    def test_rate_zero_returns_red_hex(self) -> None:
        """profit_rate=0.0 should return phosphor_burn_red hex."""
        result = profit_rate_to_hex(0.0)
        assert result == "#d40000"

    def test_rate_one_returns_green_hex(self) -> None:
        """profit_rate=1.0 should return data_green hex."""
        result = profit_rate_to_hex(1.0)
        assert result == "#39ff14"

    def test_rate_half_returns_midpoint_hex(self) -> None:
        """profit_rate=0.5 should return midpoint hex."""
        result = profit_rate_to_hex(0.5)
        # (134, 127, 10) -> #867f0a
