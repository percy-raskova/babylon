...
LARGE_BLOB_EXEMPTIONS: frozenset[str] = frozenset(
    {
        ...
        # Self-hosted TIGER county substrate (spec-113 Living Map "no CDN"
        # basemap) served by the frontend and read by every vite build + e2e
        # checkout. Generated by tools/build_geo_assets.mjs; same LFS-quota
        # reasoning as seed_influences above — tolerated in-pack at 2.4MB.
        "src/frontend/public/geo/counties.topojson",
